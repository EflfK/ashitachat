...
$required = @(
    ...
    "elseif (window.show_tabs ~= true and has_tell_tabs(window))",
    "chat_display_mode(e)",
    ...
    "HOVER_FADE_IN_SECONDS = 0.30",
    "HOVER_FADE_OUT_SECONDS = 0.45",
    "update_hover_focus(window, window.hovered == true)",
...
$requiredConfig = @(
    ...
    "tabs = {",
    "filters = { 'progress', 'auction', 'mission' }",
